...
# define M68KASM_TOKENTYPE
  enum m68kasm_tokentype
  {
    ...
    TOKEN_DIRECTIVE_ORG = 375,     /* TOKEN_DIRECTIVE_ORG  */
    TOKEN_DIRECTIVE_DC = 376,      /* TOKEN_DIRECTIVE_DC  */
    TOKEN_DIRECTIVE_DCB = 377,     /* TOKEN_DIRECTIVE_DCB  */
    ...
    TOKEN_SIZE_BYTE = 400,         /* TOKEN_SIZE_BYTE  */
    TOKEN_SIZE_SHORT = 401,        /* TOKEN_SIZE_SHORT  */
    TOKEN_SIZE_WORD = 402,         /* TOKEN_SIZE_WORD  */
    TOKEN_SIZE_LONGWORD = 403,     /* TOKEN_SIZE_LONGWORD  */
    TOKEN_DATA_REGISTER = 404,     /* TOKEN_DATA_REGISTER  */
    TOKEN_ADDRESS_REGISTER = 405,  /* TOKEN_ADDRESS_REGISTER  */
    TOKEN_NUMBER = 406,            /* TOKEN_NUMBER  */
    TOKEN_IDENTIFIER = 407,        /* TOKEN_IDENTIFIER  */
    TOKEN_LOCAL_IDENTIFIER = 408,  /* TOKEN_LOCAL_IDENTIFIER  */
    TOKEN_STRING = 409,            /* TOKEN_STRING  */
    TOKEN_STATUS_REGISTER = 410,   /* TOKEN_STATUS_REGISTER  */
    TOKEN_CONDITION_CODE_REGISTER = 411, /* TOKEN_CONDITION_CODE_REGISTER  */
    TOKEN_USER_STACK_POINTER_REGISTER = 412, /* TOKEN_USER_STACK_POINTER_REGISTER  */
    TOKEN_PROGRAM_COUNTER = 413,   /* TOKEN_PROGRAM_COUNTER  */
    TOKEN_LOGICAL_AND = 414,       /* TOKEN_LOGICAL_AND  */
    TOKEN_LOGICAL_OR = 415,        /* TOKEN_LOGICAL_OR  */
    TOKEN_EQUALITY = 416,          /* TOKEN_EQUALITY  */
    TOKEN_INEQUALITY = 417,        /* TOKEN_INEQUALITY  */
    TOKEN_LESS_OR_EQUAL = 418,     /* TOKEN_LESS_OR_EQUAL  */
    TOKEN_MORE_OR_EQUAL = 419,     /* TOKEN_MORE_OR_EQUAL  */
    TOKEN_LEFT_SHIFT = 420,        /* TOKEN_LEFT_SHIFT  */
    TOKEN_RIGHT_SHIFT = 421,       /* TOKEN_RIGHT_SHIFT  */
    TOKEN_STRLEN = 422             /* TOKEN_STRLEN  */
  };
